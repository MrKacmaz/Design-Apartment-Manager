        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="complaint.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-megaphone" viewBox="0 0 16 16">
        ...
        <div class="cmp">
            <form class="was-validated" action="index/complains.php" method="POST">
                <div class="mb-3">
                    ...
                    <select class="form-select" id="exampleFormControlInput1" name="about" required>
                        <option value="NULL" selected>Select your Subject</option>
                ...
                <br><br>
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Please describe your complaint in 250 words</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="userComplain" rows="3" required></textarea>
                </div>
                <?php
                if (isset($_GET['complaint'])) {
                    if ($_GET['complaint'] == "success") {
                        echo "<br><div class='alert alert-success' role='alert'>Your complaint has been sent</div>";
                    } elseif ($_GET['complaint'] == 'failed') {
                        echo "<br><div class='alert alert-danger' role='alert'>Your complaint could not be sent</div>";
                    }
                }
                ?>
                <label for="userComplain-btn"></label>
                <input type="submit" name="userComplain-btn" id="sub" class="btn btn-primary me-md-2 btn-lg">


                <label for="reset"></label>
                <input type="reset" name="reset" id="reset" class="btn btn-danger me-md-2 btn-lg">
