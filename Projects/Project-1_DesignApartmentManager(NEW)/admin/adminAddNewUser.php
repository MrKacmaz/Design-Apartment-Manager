            ...
            <form class="was-validated" action="../index/new_user_sign.php" method="POST">
                <div class="label">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="invalid-feedback">
                            Please enter a Username in the textarea
                        </div>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">#FLAT</span>
                        <input type="text" name="userFlatno" id="userFlatno" class="form-control" max="10" min="1" required>
                        <div class="invalid-feedback">
                            Please enter a Flat number in the textarea
                        </div>
                    </div>
                    <div class="input-group mb-3">
