...
<head>
    ...
    <link href="../css/admin/adminComplain.css" rel="stylesheet">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="adminComplaint.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-exclamation-circle" viewBox="0 0 16 16">
    ...
    <main class="main">
        <div class="section">
            <table class="table">
                ...
                ?>
                    <tr>
                        ...
                        <td align="center"><button class="btn btn-danger" onclick="deleteFun()"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-x-square" viewBox="0 0 16 16">
            ...
            if (isset($_GET['delete'])) {
                if ($_GET['delete'] == "ok") {
                    echo "<div class='alert alert-success' role='alert'>Succesfully Deleted</div>";
