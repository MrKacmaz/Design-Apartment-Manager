    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="adminComplaint.php">COMPLAINTS</a></li>
            ...
            <table class="table">
                ...
                ?>
                    <tr>
                        ...
                        <td align="center"><button class="btn btn-danger" onclick="deleteFun()">Delete</button></td>
                    </tr>
                    <script>
                        function deleteFun() {
