		...
		<div class="main-update">
			<form action="update.php" method="POST">
				<div class="input-group mb-3">
					...
					<input type="text" required name="userName" class="form-control" value="<?php echo $bilgilerimcek['userName'] ?>">
				</div>
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon1">LAST</span>
					<input type="text" required name="userSurname" class="form-control" value="<?php echo $bilgilerimcek['userSurname'] ?>">
				</div>
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon1">E-MAIL</span>
					<input type="text" required name="userEmail" class="form-control" value="<?php echo $bilgilerimcek['userEmail'] ?>">
				</div>
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon1">USER NAME</span>
					<input type="text" required name="userUsername" class="form-control" value="<?php echo $bilgilerimcek['userUsername'] ?>">
				</div>
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon1">#FLAT</span>
					<input type="int" required name="userFlatno" class="form-control" value="<?php echo $bilgilerimcek['userFlatno'] ?>">
				</div>
				<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon1">GSM</span>
					<input type="text" required name="userGSM" class="form-control" value="<?php echo $bilgilerimcek['userGSM'] ?>">
				</div>
