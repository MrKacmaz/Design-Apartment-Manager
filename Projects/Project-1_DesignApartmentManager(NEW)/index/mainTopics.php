        ...
        <div class="main-update">
            ...
            <form action="mainTopics.php" method="POST">
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Main Topic ID</span>
                    <input type="int" class="form-control" value="<?php echo $bilgilerimcek['mainTopicsID'] ?>" name="mainTopicsID">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Main Topic Time</span>
                    <input disabled type="text" class="form-control" required value="<?php echo $bilgilerimcek['mainTopicsTime'] ?>" name="mainTopicsTime" id="mainTopicsTime">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Old Main Topic Title</span>
                    <input disabled type="text" class="form-control" required value="<?php echo $bilgilerimcek['mainTopicsTitle'] ?>" name="mainTopicsTitle" id="mainTopicsTitle">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Old Main Topic Content</span>
                    <input disabled type="text" class="form-control" required value="<?php echo $bilgilerimcek['mainTopicsContent'] ?>" name="mainTopicsContent" id="mainTopicsContent">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">New Main Topic Title</span>
                    <textarea name="NewMainTopicsTitle" id="NewMainTopicsTitle" cols="6" rows="5" class="form-control"><?php echo $bilgilerimcek['mainTopicsTitle'] ?></textarea>
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">New Main Topic Content</span>
                    <textarea name="NewMainTopicsContent" id="NewMainTopicsContent" cols="6" rows="5" class="form-control"><?php echo $bilgilerimcek['mainTopicsContent'] ?></textarea>
                </div>
                <div class="input-group mb-3">
